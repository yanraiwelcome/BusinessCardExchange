...
public class P2PManager {
    ...
    public static String SAVE_DIR = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES+File.separator+P2PConstant.FILE_SHARE_SAVE_PATH).getPath();
////Environment.getExternalStorageDirectory().getPath()
    ...
    public P2PManager(Context context) {
        ...
        Log.e("Location",":"+SAVE_DIR);
    }

    public static String getSavePath(int type) {
        String[] typeStr = {"Zip", "Picture"};
    ...
    public void receiveFile(ReceiveFile_Callback callback) {
        ...
        p2PHandler.initReceive(mContext);
    }
