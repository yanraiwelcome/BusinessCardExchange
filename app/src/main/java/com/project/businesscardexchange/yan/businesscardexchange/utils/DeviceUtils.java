package com.project.businesscardexchange.yan.businesscardexchange.utils;
...
public class DeviceUtils {
    ...
    public static void exportDB(){
        ...
        try {
            ...
            Log.e("DB_EXPORT", "Success:" + backupDBPath);
        } catch(IOException e) {
            e.printStackTrace();
            Log.e("DB_EXPORT","Error:"+e.getLocalizedMessage());
