...
//
        ...
        */
        ...
        //GENERATE PAYLOAD
        BusinessCard mBCard = new BusinessCard();
        mBCard.setCompanyName(prefs.getString(COMPANY_NAME, "NA"));
        mBCard.setName(prefs.getString(NAME, "NA"));
        mBCard.setEmailAddress(prefs.getString(EMAIL_ADDRESS, "NA"));
        mBCard.setPhone(prefs.getString(PHONE, "NA"));
        mBCard.setWebsiteUrl(prefs.getString(WEBSITE_URL, "NA"));
        mBCard.setStreet(prefs.getString(STREET,"NA"));
        mBCard.setState(prefs.getString(STATE,"NA"));
        mBCard.setPost(prefs.getString(POST,"NA"));
        mBCard.setDirectPhone(prefs.getString(PHONE_DIRECT_LINE,"NA"));
        mBCard.setPhoto(prefs.getString(PHOTO,"NA"));
        mBCard.setPhotocompanylogo(prefs.getString(PHOTO_COMPANY_LOGO,"NA"));
        mBCard.setCity(prefs.getString(CITY,"NA"));
        mBCard.setZipCode(prefs.getString(ZIPCODE,"NA"));
        mBCard.setTimestamp(prefs.getString(TIMESTAMP,"NA"));
        mBCard.setCountryName(prefs.getString(COUNTRY_NAME,"NA"));
        mBCard.setIsOwn(0);
...
//new
        ...
        {
            Toast.makeText(getApplicationContext(), "Can not share :"+mBCard.getName(), Toast.LENGTH_SHORT).show();
            byte[] payLoad2 = null;
            //GENERATE NFC MESSAGE
            return new NdefMessage(
                    new NdefRecord[]{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nfcAdapter = NfcAdapter.getDefaultAdapter(MyCardActivity.this);
